...
This will pull the latest changes, update dependencies (if needed), run migrations, and optionally re-seed the database.
...
- Runs database migrations
- Optionally re-seeds database with fresh sample data (asks first)
