...
function renderThemeSection(sectionKey, label, hint) {
  const wrapper = document.createElement("div");
...
function renderThemeSelectField(sectionKey, prop, label, values, isSize = false) {
...
function renderThemeColorField(sectionKey, prop, label, values) {
  ...
  const colorInput = document.createElement("input");
  colorInput.type = "color";
  colorInput.value = current || "#000000";
