...
class AssetAdmin(admin.ModelAdmin):
    list_display = ("title","collection","kind","effective_visibility","is_external","updated_at")
    ...
    fieldsets = (
        (None, {"fields": ("title","slug","collection","visibility","description","tags","appears_on")}),
        ("Source", {"fields": ("file","url","text_content")}),
        ("Detected", {"fields": ("mime_type","kind","size_bytes","width","height","duration_seconds","pages")}),
        ("Timestamps", {"fields": ("created_at","updated_at")}),
    )

    def effective_visibility(self, obj): return obj.effective_visibility
