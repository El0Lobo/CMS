...
class MessageThreadAdmin(admin.ModelAdmin):
    list_display = ("id", "type", "account", "subject", "created_at", "last_activity_at", "is_closed")
    list_filter = ("type", "is_closed", "account")
    search_fields = ("subject",)

@admin.register(models.Message)
class MessageAdmin(admin.ModelAdmin):
    list_display = ("id", "thread", "direction", "sender_user", "sent_at", "received_at", "created_at")
...
class AttachmentAdmin(admin.ModelAdmin):
    list_display = ("id", "message", "filename", "mime_type", "size_bytes", "scan_status", "is_inline")
