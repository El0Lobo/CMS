...
from . import views_inbox, views_threads, views_compose, views_mail
...
urlpatterns=[
    ...
    path("compose/internal/modal/", views_compose.compose_internal_modal, name="compose_internal_modal"),
