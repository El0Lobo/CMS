...
class ProductVariantForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "size_label": forms.TextInput(attrs={"class":"form-control", "placeholder":"S / M / L or custom"}),
            "color": forms.TextInput(attrs={"class":"form-control", "placeholder":"Black / Red ..."}),
...
ProductVariantFormSet = inlineformset_factory(
    ...
    form=ProductVariantForm, extra=0, can_delete=True
)
